<template>
  <div class="text-center full-page">
...
.full-page {
  ...
  background-image: url('https://images.unsplash.com/photo-1524721696987-b9527df9e512?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2690&q=80');
  display: -ms-flexbox;
  display: flex;
  color: #fff;
